...
- C3 - [Precipitation, Temperature, Relative Sunshine Duration (Ground-based spatial climate data)](#c3---ground-based-spatial-climate-data) :yellow_circle: *documentation to be reviewed*
...
**Diffuse Radiation**
- *Hourly*, Daily, Monthly and Yearly *satellite-based* Diffuse Radiation
  - :yellow_circle: *ProdDoc (PDF) URL ?*

**Direct Radiation**
- *Hourly*, Daily, Monthly and Yearly *satellite-based* Direct Radiation
  - :yellow_circle: *ProdDoc (PDF) URL ?*
